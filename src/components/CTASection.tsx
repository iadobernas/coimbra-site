    ...
    <section className="bg-white border-t-4 border-[#1a6b3a] py-12 md:py-20 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
          <Link
            href="/catalogo"
            className="inline-flex items-center justify-center gap-2 text-white font-bold px-8 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg text-lg"
