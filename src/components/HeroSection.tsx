...
export default function HeroSection() {
  return (
    <section
      ...
      style={{
        minHeight: '100vh',
        background: 'linear-gradient(135deg, #0d4a24 0%, #1a6b3a 60%, #1e7d42 100%)',
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <div className="inline-flex items-center gap-2.5 rounded-full px-4 py-2 mb-8"
                ...
                <span className="text-white/90 text-sm font-display font-semibold tracking-wide">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <Link
                  href="/catalogo"
                  className="inline-flex items-center justify-center gap-2 font-display font-bold px-8 py-4 rounded-xl text-[#1a6b3a] bg-white transition-all duration-200 hover:shadow-2xl hover:-translate-y-0.5 text-lg shadow-lg"
                >
                  Explorar Catálogo
